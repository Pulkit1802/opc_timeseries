    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className='mb-4 px-6 py-2'>
                <input 
                className='border py-2 px-4 rounded-lg block mx-auto w-5/6 outline-none hover:outline-none focus:outline-none border-gray-600 hover:bg-white focus:bg-white' 
                type="text" name='variableNodeId' value={formData.variableNodeId} onChange={handleChange} placeholder="Node Id" />
            </div>
            <div className='mb-4 px-6 py-2'>
                <input 
                className='border py-2 px-4 rounded-lg block mx-auto w-5/6 outline-none hover:outline-none focus:outline-none border-gray-600 hover:bg-white focus:bg-white' 
            ...
            <div className='mb-4 px-6 py-2'>
                <input 
                className='bg-blue-500 cursor-pointer hover:bg-blue-700 text-white duration-300 font-bold py-2 px-4 rounded-lg block mx-auto w-5/6 outline-none hover:outline-none focus:outline-none' 
